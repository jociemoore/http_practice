 ...
 * @apiGroup Staff
 * 
 * @apiParam {Number} id (required) ID of Staff
 ...
 *     'Schedules added'
 * 
 * @apiError InvalidInput When the schedules can not be saved due to invalid inputs. If more than schedule is to be added, all schedules must have a valid input. Otherwise, none of the schedules (even those with valid inputs) get saved.
 * @apiErrorExample {String} InvalidInput Error-Response:
 *     HTTP/1.1 400 Bad Request
